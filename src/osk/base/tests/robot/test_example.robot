...
#
#  $ bin/test -s osk.base -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src osk.base.testing.OSK_BASE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/osk/base/tests/robot/test_example.robot
#
